            ...
            <header className='flex flex-col gap-5 md:gap-8'>
                <Link href="/" className="cursor-pointer flex items-center gap-1 px-4">
                    <Image
                        ...
                        alt="Rupeeflow Logo"
                    />
                    <h1 className='text-26 font-ibm-plex-serif font-bold text-black-1'>RupeeFlow</h1>
                </Link>
                                ...
                                <>
                                    ...
                                    <div className='flex gap-4'>
                                        <CustomInput control={form.control} name='state'
                                            label='State' placeholder='Example: Odisha'
                                        />

                                        <CustomInput control={form.control} name='postalCode'
                                            label='Postal Code' placeholder='Example: 753001'
                                        />
                                    </div>
                                    <div className='flex gap-4'>
                                        ...
                                        <CustomInput control={form.control} name='pan'
                                            label='PAN' placeholder='Enter your PAN'
                                        />
                                    </div>
                                </>
                            )}
